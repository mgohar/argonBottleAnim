...
gltfLoader.load(model1, (gltf) => {
  ...
  gltfLoader.load(model2, (gltf) => {
    gltf.scene.position.set(100, -450, 0);
    gltf.scene.rotation.set(-163.786, 0, -176.3);
    gltf.scene.scale.set(60, 60, 60);
    bottle02 = gltf.scene;
    ...
    // light3Degugger();
    // light4Degugger();
    // positionDegugger(scene.getObjectByName("__double_macadamia1"));
    bottleAnimation();
    bottleHideAnimation(); 
...
// Argoan 1
createAssets("__double_argon1", "argon1.png", 360, -57, 0, 60, 60);
createAssets("__double_argon2", "argon1.png", 213.2911,-81.7248, 0, 40, 40);


// Argan 2
createAssets("__argon1", "argon2.png", 360, -57, 0, 60, 60);
createAssets("__argon2", "argon2.png", 360, -57, 0, 40, 40);
createAssets("__argon3", "argon2.png", 164.1218,25, 0, 30, 30);
createAssets("__argon4", "argon2.png", 470,-120, 0, 20, 20);
createAssets("__argon5", "argon2.png", 360, -57, 0, 20, 20);
createAssets("__argon6", "argon2.png", 360, -57, 0, 10, 10);
createAssets("__argon7", "argon2.png", 360, -57, 0, 10, 10);
createAssets("__argon8", "argon2.png", 360, -57, 0, 10, 10);
createAssets("__argon9", "argon2.png", 360, -57, 0, 10, 10);
createAssets("__argon10", "argon2.png", 360, -57, 0, 10, 10);


// Macadamia
createAssets("__macadamia1", "macadamia.png", 360, -57, 0, 70, 60);
createAssets("__macadamia2", "macadamia.png", 114.9525,-155.4787, 0, 60, 45);
createAssets("__macadamia3", "macadamia.png", 360, -57, 0, 40, 30);
createAssets("__macadamia4", "macadamia.png", 360, -57, 0, 35, 25);
createAssets("__macadamia5", "macadamia.png", 360, -57, 0, 35, 25);
createAssets("__macadamia6", "macadamia.png", 360, -57, 0, 20, 15);


// positionDegugger(scene.getObjectByName("__honey1"),"honey1");

// Macadamia Double
createAssets("__double_macadamia1", "macadamia2.png", 434.553,-240, 0, 60, 50);

// ShellMacadamia
createAssets("__shellmacadamia1", "shellmacadamia.png", 188.7064,65.7832, 0, 65, 65);
createAssets("__shellmacadamia2", "shellmacadamia.png", 360, -57, 0, 37, 37);
createAssets("__shellmacadamia3", "shellmacadamia.png", 390,-155.4787, 0, 37, 37);
createAssets("__shellmacadamia4", "shellmacadamia.png", 508.3069,-115, 0, 30, 30);
createAssets("__shellmacadamia5", "shellmacadamia.png", 360, -57, 0, 20, 20);
createAssets("__shellmacadamia6", "shellmacadamia.png", 360, -57, 0, 18, 18);
createAssets("__shellmacadamia7", "shellmacadamia.png", 188.7064,13, 0, 15, 15);
createAssets("__shellmacadamia8", "shellmacadamia.png", 360, -57, 0, 10, 10);
createAssets("__shellmacadamia9", "shellmacadamia.png", 360, -57, 0, 8, 8);
createAssets("__shellmacadamia10", "shellmacadamia.png", 360, -57, 0, 8, 8);
createAssets("__shellmacadamia11", "shellmacadamia.png", 360, -57, 0, 8, 8);
createAssets("__shellmacadamia12", "shellmacadamia.png", 360, -57, 0, 8, 8);

// Honey
createAssets("__honey1", "honey3.png", 483.7223,-57.1401, 0, 180, 180);
createAssets("__honey2", "honey4.png", 90.3678,-32.5555, 0, 60, 60);
createAssets("__honey3", "honey2.png", 360, -57, 0, 50, 50);
createAssets("__honey4", "honey1.png", 360, -57, 0, 50, 50);
